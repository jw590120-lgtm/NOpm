...
export const rules: TriggerRule[] = [
  {
    ...
    name: '成长阶段 → 推荐规划下一代',
    category: '市场',
    description: '产品进入销售成长期后，应在1~4年内规划下一代产品，确保产品线持续更新',
    condition: { type: 'time_since', stageId: 'growth', yearsMin: 1, yearsMax: 4 },
  ...
  },
  {
    ...
    name: '注册阶段产品 → 关注竞品动态',
    category: '技术',
    description: '产品在注册阶段时密切关注竞品新技术发布',
    condition: { type: 'stage_match', productIdPattern: 'nplus', stageId: 'register' },
    action: 'alert',
    priority: 'medium',
    enabled: true,
  },
  {
    ...
    name: '供应链重大变更 → 风险评估',
    category: '供应链',
    description: '当核心原材料供应商发生重大变更时，提示供应链风险评估（需接入外部数据）',
  ...
  },
  {
    ...
    name: '临床试验数据异常 → 暂停警告',
    category: '临床',
    description: '当临床试验中出现异常不良事件率超过阈值时发出警告（需接入外部数据）',
